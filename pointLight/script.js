onload = function () {
    ...
    */
    ...
    // トーラスモデル(頂点)データ
    var torusData = torus(24, 48, 0.3, 1);
    ...
    (function () {
        ...
        //veiw
        // ビュー座標変換行列
        var eyeDirection = [7 * Math.sin(theta), 0, 7 * Math.cos(theta)];
        ...
        {//トーラス
            //モデル行列
            m.identity(mMatrix);
            m.translate(mMatrix, [0, -3, 0], mMatrix);
            m.rotate(mMatrix, theta, [1, 0, 0], mMatrix);
            //m.rotate(mMatrix, theta + Math.PI / 2, [0, 0, 1], mMatrix);
        ...
        {//球
            //モデル行列
            m.identity(mMatrix);
            m.translate(mMatrix, [3, 3, 0], mMatrix);
